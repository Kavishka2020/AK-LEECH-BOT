...
DEF_THUMB_NAIL_VID_S = os.environ.get("DEF_THUMB_NAIL_VID_S", "https://i.ibb.co/C9v9n1s/20211226-200127.jpg")
...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "lee")
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leeunzip")
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leezip")
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "glee")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleeunzip")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleezip")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdlx")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdlx")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "Maxx-TD")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleex")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get("TELEGRAM_LEECH_UNZIP_COMMAND", "tleeunzip")
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "stalee")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "thumbx")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbx")
...
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "renamex")
